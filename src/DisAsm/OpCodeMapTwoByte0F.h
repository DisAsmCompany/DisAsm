...
{
	/* 0F00h - 0F07h */
	{GROUP6, OP0}, {GROUP7, OP0}, {LAR, OP2(Gv, Ew)}, {LSL, OP2(Gv, Ew)}, {LOADALL, OP0}, {SYSCALL, OP0}, {CLTS, OP0}, {SYSRET, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F08h - 0F0Fh */
	{INVD, OP0}, {WBINVD, OP0}, {DB, OP0}, {UD2, OP0}, {DB, OP0}, {GROUPP, OP1(Mb)}, {FEMMS, OP0}, {ESCAPE3DNOW, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F10h - 0F17h */
	...
	{MOVSD,  OP2(Vsd, Wsd)}, {MOVSD,  OP2(Wsd, Vsd)}, {MOVDDUP, OP2(Vo, Wsd)},   {DB, OP0},              {DB, OP0},                 {DB, OP0},                 {DB, OP0},                 {DB, OP0},
	{MOVSS,  OP2(Vss, Wss)}, {MOVSS,  OP2(Wss, Vss)}, {MOVSLDUP, OP2(Vps, Wps)}, {DB, OP0},              {DB, OP0},                 {DB, OP0},                 {MOVSHDUP, OP2(Vps, Wps)}, {DB, OP0},
	/* 0F18h - 0F1Fh */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F20h - 0F27h */
	{MOV, OP2(Rd, Cd)}, {MOV, OP2(Rd, Dd)}, {MOV, OP2(Cd, Rd)}, {MOV, OP2(Dd, Rd)}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F28h - 0F2Fh */
	...
	{DB, OP0},               {DB, OP0},               {CVTSI2SD, OP2(Vsd, Ey)},  {MOVNTSD, OP2(Mo, Vsd)}, {CVTTSD2SI, OP2(Ey, Wsd)},  {CVTSD2SI, OP2(Ey, Wsd)},  {DB, OP0},                {DB, OP0},
	{DB, OP0},               {DB, OP0},               {CVTSI2SS, OP2(Vss, Ey)},  {MOVNTSS, OP2(Mo, Vss)}, {CVTTSS2SI, OP2(Ey, Wss)},  {CVTSS2SI, OP2(Ey, Wss)},  {DB, OP0},                {DB, OP0},
	/* 0F30h - 0F37h */
	{WRMSR, OP0}, {RDTSC, OP0}, {RDMSR, OP0}, {RDPMC, OP0}, {SYSENTER, OP0}, {SYSEXIT, OP0}, {DB, OP0}, {GETSEC, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F38h - 0F3Fh */
	{ESCAPE, OP0}, {DB, OP0}, {ESCAPE, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F40h - 0F47h */
	...
	{MOVMSKPD, OP2(Gd, Upd)}, {SQRTPD, OP2(Vpd, Wpd)}, {DB, OP0},                {DB, OP0},              {ANDPD, OP2(Vpd, Wpd)}, {ANDNPD, OP2(Vpd, Wpd)}, {ORPD, OP2(Vpd, Wpd)}, {XORPD, OP2(Vpd, Wpd)},
	{DB, OP0},                {SQRTSD, OP2(Vsd, Wsd)}, {DB, OP0},                {DB, OP0},              {DB, OP0},              {DB, OP0},               {DB, OP0},             {DB, OP0},
	{DB, OP0},                {SQRTSS, OP2(Vss, Wss)}, {RSQRTSS, OP2(Vss, Wss)}, {RCPSS, OP2(Vss, Wss)}, {DB, OP0},              {DB, OP0},               {DB, OP0},             {DB, OP0},
	/* 0F58h - 0F5Fh */
	...
	{ADDSD, OP2(Vsd, Wsd)}, {MULSD, OP2(Vsd, Wsd)}, {CVTSD2SS, OP2(Vss, Wsd)}, {DB, OP0},                 {SUBSD, OP2(Vsd, Wsd)}, {MINSD, OP2(Vsd, Wsd)}, {DIVSD, OP2(Vsd, Wsd)}, {MAXSD, OP2(Vsd, Wsd)},
	...
	{DB, OP0},                  {DB, OP0},                  {DB, OP0},                  {DB, OP0},                 {DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},
	/* 0F68h - 0F6Fh */
	{PUNPCKHBW, OP2(Pq, Qd)}, {PUNPCKHWD, OP2(Pq, Qd)}, {PUNPCKHDQ, OP2(Pq, Qd)}, {PACKSSDW, OP2(Pq, Qq)}, {DB, OP0},                 {DB, OP0},                 {MOVD, OP2(Py, Ey)}, {MOVQ, OP2(Pq, Qq)},
	...
	{DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},               {DB, OP0},                 {DB, OP0},                 {DB, OP0},           {DB, OP0},
	{DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},               {DB, OP0},                 {DB, OP0},                 {DB, OP0},           {MOVDQU, OP2(Vo, Wo)},
	/* 0F70h - 0F77h */
	{PSHUFW, OP3(Pq, Qq, Ib)},  {GROUP12, OP0},    {GROUP13, OP0},    {GROUP14, OP0},    {PCMPEQB, OP2(Ppk, Qpk)}, {PCMPEQW, OP2(Ppi, Qpi)}, {PCMPEQD, OP2(Ppj, Qpj)}, {EMMS, OP0},
	{PSHUFD, OP3(Vo, Wo, Ib)},  {GROUP12_66, OP0}, {GROUP13_66, OP0}, {GROUP14_66, OP0}, {PCMPEQB, OP2(Vpk, Wpk)}, {PCMPEQW, OP2(Vpk, Wpk)}, {PCMPEQD, OP2(Vpk, Wpk)}, {DB, OP0},
	{PSHUFLW, OP3(Vq, Wq, Ib)}, {DB, OP0},         {DB, OP0},         {DB, OP0},         {DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},
	{PSHUFHW, OP3(Vq, Wq, Ib)}, {DB, OP0},         {DB, OP0},         {DB, OP0},         {DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},
	/* 0F78h - 0F7Fh */
	{VMREAD, OP2(Ey, Gy)},            {VMWRITE, OP2(Gy, Ey)},   {DB, OP0}, {DB, OP0}, {DB, OP0},               {DB, OP0},               {MOVD, OP2(Ey, Py)}, {MOVQ, OP2(Qq, Pq)},
	{GROUP17, OP0},                   {EXTRQ, OP2(Voq, Uo)},    {DB, OP0}, {DB, OP0}, {HADDPD, OP2(Vpd, Wpd)}, {HSUBPD, OP2(Vpd, Wpd)}, {MOVD, OP2(Vy, Ey)}, {MOVDQA, OP2(Wo, Vo)},
	{INSERTQ, OP4(Voq, Uoq, Ib, Ib)}, {INSERTQ, OP2(Voq, Uoq)}, {DB, OP0}, {DB, OP0}, {HADDPS, OP2(Vps, Wps)}, {HSUBPS, OP2(Vps, Wps)}, {DB, OP0},                {DB, OP0},
	{DB, OP0},                        {DB, OP0},                {DB, OP0}, {DB, OP0}, {DB, OP0},               {DB, OP0},               {MOVQ, OP2(Vq, Wq)}, {MOVDQU, OP2(Wo, Vo)},
	/* 0F80h - 0F87h */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FA0h - 0FA7h */
	{PUSH, OP1(FS)}, {POP, OP1(FS)}, {CPUID, OP0}, {BT, OP2(Ev, Gv)}, {SHLD, OP3(Ev, Gv, Ib)}, {SHLD, OP3(Ev, Gv, CL)}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FA8h - 0FAFh */
	{PUSH, OP1(GS)}, {POP, OP1(GS)}, {RSM, OP0}, {BTS, OP2(Ev, Gv)}, {SHRD, OP3(Ev, Gv, Ib)}, {SHRD, OP3(Ev, Gv, CL)}, {GROUP15, OP0}, {IMUL, OP2(Gv, Ev)},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FB0h - 0FB7h */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FB8h - 0FBFh */
	{JMPE, OP1(Jz)},       {GROUP10, OP0}, {GROUP8, OP2(Ev, Ib)}, {BTC, OP2(Ev, Gv)}, {BSF, OP2(Gv, Ev)},   {BSR, OP2(Gv, Ev)},   {MOVSX, OP2(Gv, Eb)}, {MOVSX, OP2(Gv, Ev)},
	{DB, OP0},             {DB, OP0},      {DB, OP0},             {DB, OP0},          {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},
	{DB, OP0},             {DB, OP0},      {DB, OP0},             {DB, OP0},          {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},
	{POPCNT, OP2(Gv, Ev)}, {DB, OP0},      {DB, OP0},             {DB, OP0},          {LZCNT, OP2(Gv, Ev)}, {LZCNT, OP2(Gv, Ev)}, {DB, OP0},            {DB, OP0},
	/* 0FC0h - 0FC7h */
	{XADD, OP2(Eb, Gb)}, {XADD, OP2(Ev, Gv)}, {CMPPS, OP3(Vps, Wps, Ib)}, {MOVNTI, OP2(My, Gy)}, {PINSRW, OP3(Pq, Ew, Ib)}, {PEXTRW, OP3(Gd, Nq, Ib)}, {SHUFPS, OP3(Vps, Wps, Ib)}, {GROUP9, OP0},
	{DB, OP0},           {DB, OP0},           {CMPPD, OP3(Vpd, Wpd, Ib)}, {DB, OP0},             {PINSRW, OP3(Vo, Ew, Ib)}, {PEXTRW, OP3(Gd, Uo, Ib)}, {SHUFPD, OP3(Vpd, Wpd, Ib)}, {DB, OP0},
	{DB, OP0},           {DB, OP0},           {CMPSD, OP3(Vsd, Wss, Ib)}, {DB, OP0},             {DB, OP0},                 {DB, OP0},                 {DB, OP0},                   {DB, OP0},
	{DB, OP0},           {DB, OP0},           {CMPSS, OP3(Vss, Wss, Ib)}, {DB, OP0},             {DB, OP0},                 {DB, OP0},                 {DB, OP0},                   {DB, OP0},
	/* 0FC8h - 0FCFh */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FD0h - 0FD7h */
	{DB, OP0},                 {PSRLW, OP2(Pq, Qq)}, {PSRLD, OP2(Pq, Qq)}, {PSRLQ, OP2(Pq, Qq)}, {PADDQ, OP2(Pq, Qq)}, {PMULLW, OP2(Pq, Qq)}, {DB, OP0},              {PMOVMSKB, OP2(Gd, Nq)},
	...
	{ADDSUBPS, OP2(Vps, Wps)}, {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},             {MOVDQ2Q, OP2(Pq, Uq)}, {DB, OP0},
	{DB, OP0},                 {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},            {DB, OP0},             {MOVQ2DQ, OP2(Vo, Nq)}, {DB, OP0},
	/* 0FD8h - 0FDFh */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FE0h - 0FE7h */
	{PAVGB, OP2(Pq, Qq)}, {PSRAW, OP2(Pq, Qq)}, {PSRAD, OP2(Pq, Qq)}, {PAVGW, OP2(Pq, Qq)}, {PMULHUW, OP2(Pq, Qq)}, {PMULHW, OP2(Pq, Qq)}, {DB, OP0},                       {MOVNTQ, OP2(Mq, Pq)},
	...
	{DB, OP0},                 {DB, OP0},                 {DB, OP0},                 {DB, OP0},                 {DB, OP0},                   {DB, OP0},                  {CVTPD2DQ, OP2(Vpj, Wps)},  {DB, OP0},
	{DB, OP0},                 {DB, OP0},                 {DB, OP0},                 {DB, OP0},                 {DB, OP0},                   {DB, OP0},                  {CVTDQ2PD, OP2(Vpd, Wpj)},  {DB, OP0},
	/* 0FE8h - 0FEFh */
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0FF0h - 0FF7h */
	{DB, OP0},                 {PSLLW, OP2(Pq, Qq)},   {PSLLD, OP2(Pq, Qq)},   {PSLLQ, OP2(Pq, Qq)},   {PMULUDQ, OP2(Pq, Qq)},   {PMADDWD, OP2(Pq, Qq)},   {PSADDBW, OP2(Pq, Qq)},   {MASKMOVQ, OP2(Pq, Qq)},
	{DB, OP0},                 {PSLLW, OP2(Vpq, Wpq)}, {PSLLD, OP2(Vpq, Wpq)}, {PSLLQ, OP2(Vpq, Wpq)}, {PMULUDQ, OP2(Vpj, Wpj)}, {PMADDWD, OP2(Vpi, Wpi)}, {PSADDBW, OP2(Vpk, Wpk)}, {MASKMOVDQU, OP2(Vpb, Wpb)},
	{LDDQU, OP2(Vo, Mo)},      {DB, OP0},              {DB, OP0},              {DB, OP0},              {DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},
	{DB, OP0},                 {DB, OP0},              {DB, OP0},              {DB, OP0},              {DB, OP0},                {DB, OP0},                {DB, OP0},                {DB, OP0},
	/* 0FF8h - 0FFFh */
	{PSUBB, OP2(Pq, Qq)}, {PSUBW, OP2(Pq, Qq)}, {PSUBD, OP2(Pq, Qq)}, {PSUBQ, OP2(Pq, Qq)}, {PADDB, OP2(Pq, Qq)}, {PADDW, OP2(Pq, Qq)}, {PADDD, OP2(Pq, Qq)}, {UD0, OP0},
	{PSUBB, OP2(Vo, Wo)}, {PSUBW, OP2(Vo, Wo)}, {PSUBD, OP2(Vo, Wo)}, {PSUBQ, OP2(Vo, Wo)}, {PADDB, OP2(Vo, Wo)}, {PADDW, OP2(Vo, Wo)}, {PADDD, OP2(Vo, Wo)}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
};
