...
OpCodeMapElement OpCodeMapThreeByte0F3A[] =
{
	...
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F3A08h - 0F3A0Fh */
	{DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {PALIGNR, OP3(Ppb, Qpb, Ib)},
	...
	/* 0F3A10h - 0F3A17h */
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},                       {DB, OP0},                       {DB, OP0},                       {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {PEXTRB, OP3(Mb, Vpk, Ib)}, {PEXTRW, OP3(Mw, Vpw, Ib)}, {PEXTRD, OP3(Md, Vpj, Ib)}, {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},                       {DB, OP0},                       {DB, OP0},                       {DB, OP0},
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},                       {DB, OP0},                       {DB, OP0},                       {DB, OP0},
	/* 0F3A17h - 0F3A1Fh */
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	...
	/* 0F3A20h - 0F3A27h */
	{DB, OP0},                       {DB, OP0},                         {DB, OP0},                       {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{PINSRB, OP3(Vpk, Mb, Ib)}, {INSERTPS, OP3(Vps, Md, Ib)}, {PINSRD, OP3(Vpj, Ed, Ib)}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                       {DB, OP0},                         {DB, OP0},                       {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                       {DB, OP0},                         {DB, OP0},                       {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F3A28h - 0F3A2Fh */
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	...
	/* 0F3A40h - 0F3A47h */
	{DB, OP0},                      {DB, OP0},                      {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DPPS, OP3(Vps, Wps, Ib)}, {DPPD, OP3(Vpd, Wpd, Ib)}, {MPSADBW, OP3(Vpk, Wpk, Ib)}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                      {DB, OP0},                      {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                      {DB, OP0},                      {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F3A48h - 0F3A4Fh */
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	...
	/* 0F3A60h - 0F3A67h */
	{DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{PCMPESTRM, OP3(Vo, Wo, Ib)}, {PCMPESTRI, OP3(Vo, Wo, Ib)}, {PCMPISTRM, OP3(Vo, Wo, Ib)}, {PCMPISTRI, OP3(Vo, Wo, Ib)}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	{DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0},                         {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
	/* 0F3A68h - 0F3A6Fh */
	{DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0}, {DB, OP0},
